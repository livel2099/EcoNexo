  ...
  return (
    <div className="view forestry-pest-view">
      ...
      <section className="pest-map-shell">
        <MapView token={token} devices={devices} alerts={alerts} detections={detections} reports={[]} zones={zones} center={SAN_ANTONIO} earth={intel} sourceSettings={sourceSettings} showForestryAssets initialSatelliteMode={sourceSettings.copernicus_enabled ? "NDVI" : "NONE"} availableLayers={["NDVI", "MOISTURE_INDEX"]} />
      </section>
